...
export function extractCfpCandidates(body: string): CfpExtractionCandidate[] {
  ...
  const rawLines = text
    ...
    .filter(Boolean);
  const deadlineLabel =
    /deadline|due|not be entertained after|not entertained after|not be considered after|not considered after|not be accepted after|not accepted after|must arrive|drop[ -]?dead|reach us by|accept(?:ing)? papers until|received by|receipt of|last date|cut-?off|notification|camera[- ]?ready|締切|期限/i;
  ...
  for (const raw of lines) {
    if (
      !/deadline|due|not be entertained after|not entertained after|not be considered after|not considered after|not be accepted after|not accepted after|must arrive|drop[ -]?dead|reach us by|accept(?:ing)? papers until|received by|receipt of|last date|cut-?off|submission|submit|notification|camera[- ]?ready|call for papers|cfp|event|conference|開催|締切|期限|投稿|募集/i.test(
        raw,
      )
    )
      continue;
    ...
    const headerHasDeadline =
      /deadline|due|not be entertained after|not entertained after|not be considered after|not considered after|not be accepted after|not accepted after|must arrive|drop[ -]?dead|reach us by|accept(?:ing)? papers until|received by|receipt of|last date|cut-?off|submit|submission|notification|camera[- ]?ready|締切|期限/i.test(
    ...
    for (const [index, value] of extracted.entries()) {
      ...
      const deadlineSemantics =
        /deadline|due|not be entertained after|not entertained after|not be considered after|not considered after|not be accepted after|not accepted after|must arrive|drop[ -]?dead|reach us by|accept(?:ing)? papers until|received by|receipt of|last date|cut-?off|submit|submission|notification|camera[- ]?ready|締切|期限/i;
