...
describe("promotion batch", () => {
  ...
  it("extracts colon times with a glued hrs suffix (#840)", () => {
    expect(
      extractCfpCandidates("Paper submission deadline: May 15, 2026 23:59hrs AoE"),
    ).toMatchObject([{ date: "2026-05-15", time: "23:59:00", timezone: "AoE" }]);
    expect(
      extractCfpCandidates("Paper submission deadline: May 15, 2026 17:00h CET"),
    ).toMatchObject([{ date: "2026-05-15", time: "17:00:00", timezone: "CET" }]);
  });
